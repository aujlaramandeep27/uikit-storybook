...
export default {
  ...
  export const USAGE = () => `<article class="uk-comment">
  ...
  export const PRIMARY_MODIFIER = () => `<article class="uk-comment uk-comment-primary">
    <header class="uk-comment-header uk-grid-medium uk-flex-middle" uk-grid>
        <div class="uk-width-auto">
            <img class="uk-comment-avatar" src="images/avatar.jpg" width="80" height="80" alt="">
        </div>
  ...
  export const LISTS = () => `<ul class="uk-comment-list">
    <li>
